...
function CTABand() {
  ...
  const budgets = ['Até R$ 20k/mês', 'R$ 20—50k/mês', 'R$ 50—100k/mês', 'Mais que isso'];
      ...
      <div className="cta-band__inner">
        <div className="cta-band__copy" data-reveal="left">
          ...
          <div className="cta-band__contacts">
            <div>
              <span className="eyebrow eyebrow--on-purple">E-MAIL</span>
              <a href="mailto:oi@novadigital.ag">oi@novadigital.ag</a>
            </div>
            <div>
              <span className="eyebrow eyebrow--on-purple">WHATSAPP</span>
